...
- [16. LangGraph v1.x 新特性速览](#16-langgraph-v1x-新特性速览)
...
## 16. LangGraph v1.x 新特性速览

### 16.1 Functional API（函数式 API）
...
### 16.4 create_react_agent → create_agent 迁移
